...
# ============================================================
# Quantile response generation
# ============================================================

# Generate quantile-valued responses under the linear setting
generate_Y_quantile_linear <- function(
    X,
    active_mean = c(4, 8),
    active_scale = c(1),
    beta = 3 / 4,
...
# Compute Gram matrices for each predictor
...
run_experiment_table <- function(
  ...
  for (n in n_values) {
    ...
    for (trial in 1:num_trials) {
      ...
      Y_train_list <- generate_Y_quantile_linear(X_train)
      ...
      Y_valid_list <- generate_Y_quantile_linear(X_valid)
